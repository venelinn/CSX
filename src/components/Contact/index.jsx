...
export function ContactForm(props) {
  ...
  const { value:commodity, bind:bindCommodity, reset:resetCommodity } = useInput('');
  const { value:lanesQuote, bind:bindLanesQuote, reset:resetLanesQuote } = useInput('');
